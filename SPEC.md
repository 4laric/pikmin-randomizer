...
Implement arbitrary collectible records beyond the fixed native ship-part table: stable IDs, model/weight/value, collected flags and AP checks. Optional treasure rewards use a separately balanced pool and do not increase the base 28-repair goal implicitly.
