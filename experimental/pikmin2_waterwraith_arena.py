"""Waterwraith / Tyre batch-2 private arena staging (#352, parent #175).

Thin binding of :mod:`experimental.pikmin2_batch2_core` to the Waterwraith
family. BlackMan plus its Tyre child and an ordinary P1 control are staged on
the original Impact Site using the neutral Chappy placement vehicle; identity
and boss behavior are not claimed.
"""
import argparse
