"""Private Mamuta natural-observation fixture builder (lane 19, #221/#168).

Instruments tools/preview_p2_room.cpp with
scripts/pikmin2_mamuta_natural_fixture.inc: stages the rules arena and drives
the captain into the bound Miurin's territory without forcing any bury, lethal
hit or Pikmin AI action, so the native proxy AI is observed on its own. Build
modeled on pikmin2_mamuta_rules_runtime (batch 4/5).
"""
import json, os
