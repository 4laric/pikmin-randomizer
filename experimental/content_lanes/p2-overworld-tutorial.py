...
def main(argv=None):
    ...
    return 0# ---------------------------------------------------------------------------
# P1 runtime import path (lane p2-overworld-tutorial-p1-surface-session, #148).
#
...
CONTENT_PIN = "f16f272c85371dea6e8deafd86e562d4cd7d08fa"
...
P1_MISSING_CONTRACT = (
    ...
    "checkout, and content pin f16f272c85371dea6e8deafd86e562d4cd7d08fa "
