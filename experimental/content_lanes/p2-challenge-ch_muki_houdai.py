"""P0 source-audit adapter for P2 Challenge 09 ch_MUKI_houdai (#541).
...
SOURCE_PATH = "user/Mukki/mapunits/caveinfo/ch_MUKI_houdai.txt"
CAVE_ID = "ch_MUKI_houdai"
ISSUE = 541
EXPECTED_FLOORS = 2
EXPECTED_SHA256 = "07cdf2cd492024548b9982a6ed63c40ba6c781bd114814339aefc9b8b35232f3"
...
MISSING_PREREQUISITE = (
    ...
    "'user/Mukki/mapunits/caveinfo/ch_MUKI_houdai.txt' file decoded as "
...
def build_manifest(cave_text, cave_sha256=None, challenge=None):
    """Build the isolated P0 metadata packet for ch_MUKI_houdai."""
    ...
    manifest = dict(
        schema=1,
        lane="p2-challenge-ch_muki_houdai",
        cave_id=CAVE_ID,
        issue=ISSUE,
        source=SOURCE_PATH,
...
def main(argv=None):
    ...
    parser.add_argument("--cave", type=Path, default=None,
                        help="path to extracted ch_MUKI_houdai.txt")
