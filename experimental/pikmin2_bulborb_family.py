...
IDENTITIES = (
    ...
    Identity(44, 'BlueKochappy', 'Dwarf Orange Bulborb', KOCHAPPY_BASE_OBJECT,
             ...
             status='staged', native_marker='BLUEKOCHAPPY',
             evidence='docs/PIKMIN2_DWARF_VARIANTS.md batch 2 install + arena staging',
             blockers=('native registration not implemented (integration lead / #186)',
                       'full prepare() blocked on a private P1 asset copy in the recorded session',
                       'P2 source FSM not ported')),
...
GATE_STATUS = {
    ...
    'BlueKochappy': {'identity_spawn': 'staged', 'movement_animation': 'untested',
                     'attacks_receivers': 'untested', 'death_corpse': 'untested',
