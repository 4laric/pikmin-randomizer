"""Private Mamuta identity/render/reset observer, no forced enemy actions."""
import json, os
...
def instrument(source):
    ...
    app=(Path(__file__).resolve().parents[1]/'scripts/pikmin2_mamuta_fixture.inc').read_text()
    return '#include "Generator.h"\n#include "TekiPersonality.h"\n#include "pc_p2_mamuta.h"\n'+source[:start]+app+source[end:]
