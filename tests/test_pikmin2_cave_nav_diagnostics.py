...
def test_changes_only_presentation_and_logging():
    source=Path('native/pc_port/pc_p2_cave.cpp').read_text()
    if 'PIKMIN_CAVE_NAV_DIAGNOSTICS' in source:
        pytest.skip('native cave source is already instrumented in this checkout')
