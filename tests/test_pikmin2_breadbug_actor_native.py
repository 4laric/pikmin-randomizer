...
class BreadbugActorRuntimeTests(unittest.TestCase):
    ...
    def test_reentry_and_death_evidence_required(self):
        for marker in ('Experimental preview window set to 960x540 windowed and centered', 'P2_BREADBUG_ACTOR_REENTRY', 'P2_BREADBUG_ACTOR_KILL', 'P2_BREADBUG_ACTOR_DEATH '):
