"""Synthetic J3D2bmd3 model builders shared by converter tests (#429).

No disc assets; builds the tiny INF1/VTX1/SHP1/JNT1/DRW1/EVP1/MAT3/TEX1 model
used to exercise the J3D converter without local content.
"""
import struct
