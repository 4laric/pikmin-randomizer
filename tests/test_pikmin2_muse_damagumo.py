...
GOOD = "\n".join([
    "P2_MUSE_DAMAGUMO_READY squad=20 damagumo_gen=312003",
    "P2_MUSE_DAMAGUMO_BIND generator=312003 species=Damagumo native_fsm=implemented",
    "Experimental preview window set to 960x540 windowed and centered",
    "P2_MUSE_DAMAGUMO_SESSION navi=1",
    "P2_LONG_LEGS_STATE species=Damagumo generator=312003 state=Stay",
    "P2_LONG_LEGS_STATE species=Damagumo generator=312003 state=Land",
    "P2_LONG_LEGS_STATE species=Damagumo generator=312003 state=Wait",
    "P2_LONG_LEGS_STATE species=Damagumo generator=312003 state=Walk",
    "P2_LONG_LEGS_WALK species=Damagumo generator=312003 from=0.0,0.0 to=40.0,0.0 speed=100.0",
    "P2_LONG_LEGS_WALK_END species=Damagumo generator=312003 distance=38.5 seconds=0.40",
    "P2_LONG_LEGS_DEAD species=Damagumo generator=312003 health=0 prior_health=120.0",
    "P2_MUSE_DAMAGUMO_CHILD_BIRTH generator=312003 species=ShijimiChou count=25",
    "P2_MUSE_DAMAGUMO_REENTRY generator=312003 stale=0 fresh=1 rebind=1",
...
class NegativeTests(unittest.TestCase):
    ...
    def test_child_generator_disagreement_rejected(self):
        text = GOOD.replace("CHILD_BIRTH generator=312003",
    ...
    def test_wrong_species_state_ignored(self):
        text = GOOD + "\nP2_LONG_LEGS_STATE species=Houdai generator=312003 state=Walk"
        result = validate(text)
        self.assertTrue(result["passed"], result["problems"])
