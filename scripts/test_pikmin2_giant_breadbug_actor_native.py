...
GATES = {
    ...
    'defeated_module': r'P2_GIANT_DEFEATED generator=%d thrown_back=1' % GIANT_ID,
    'throwup_module': r'P2_GIANT_THROWUP generator=%d pellets=1 ' % GIANT_ID,
    'throwup_gate': r'P2_GIANT_ARENA_THROWUP pellets=1 ',
