"""Build the overworld save serializer fixture against a private build (#700).

Thin wrapper over scripts/build_pikmin2_fixture.py: links
native/tools/p2_overworld_save_serializer_fixture.cpp against the private
...
FIXTURE_REL = Path('tools/p2_overworld_save_serializer_fixture.cpp')
...
def run_guard_checks(exe, build):
    ...
    if selftest.returncode != 0 or 'P2_SAVE_FIXTURE_SELFTEST_PASS' not in selftest.stdout:
