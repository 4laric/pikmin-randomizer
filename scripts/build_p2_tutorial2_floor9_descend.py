#!/usr/bin/env python3
"""Leased private build + replacement-main link for #807 floor-9 descend (root worktree copy, adapted from the #757 pattern read-only).
...
then links tools/p2_tutorial2_floor9_descend_fixture.cpp against the pikmin_pc
...
def main():
    ...
    obj_dir = os.path.join(bld, "floor9-descend-fixture")
    os.makedirs(obj_dir, exist_ok=True)
    fixture_src = os.path.join(src, "tools",
                               "p2_tutorial2_floor9_descend_fixture.cpp")
    fixture_obj = os.path.join(obj_dir,
                               "p2_tutorial2_floor9_descend_fixture.cpp.obj")
    ...
    out_exe = os.path.join(obj_dir, "p2_tutorial2_floor9_descend_fixture.exe")
