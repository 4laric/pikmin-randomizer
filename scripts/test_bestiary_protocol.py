...
from randomizer.catalog import NEW_BESTIARY, DELIVERY_BESTIARY
...
for permanent in (False, True):
    with tempfile.TemporaryDirectory() as d:
        ...
        expected = set(NEW_BESTIARY) | set(DELIVERY_BESTIARY)
...
print('PASS: both modern check sets, all nineteen bestiary checks, delivery/defeat gating, no landing/scout checks, journal replay/deduplication')
