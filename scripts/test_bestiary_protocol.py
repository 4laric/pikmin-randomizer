"""New bestiary trigger gating and landing-only catalog, both check-set sizes."""
...
for permanent in (False, True):
    with tempfile.TemporaryDirectory() as d:
        ...
        expected = set(NEW_BESTIARY) | {'Explore: The Forest of Hope - Land'}
...
print('PASS: both modern check sets, all eleven additions, delivery/defeat gating, no scout check, journal replay/deduplication')
