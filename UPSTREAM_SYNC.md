...
- Current maintained downstream native commit: `ad82784ead43` (see ENGINE_SOURCE.md); includes the experimental Purple preview and preserves the separate release boundary.
