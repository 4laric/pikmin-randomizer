...
- Current maintained downstream native commit: `292c6830` (see ENGINE_SOURCE.md); includes experimental Purple support and two-floor cave checkpoints and preserves the separate release boundary.
