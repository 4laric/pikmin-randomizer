...
- Current maintained downstream native commit: `a78ea6d6` (see ENGINE_SOURCE.md); includes experimental Purple support and two-floor cave checkpoints and preserves the separate release boundary.
