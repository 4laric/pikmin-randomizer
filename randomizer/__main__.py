...
def main():
    ...
    gen.add_argument('--p2-enemies', action='store_true', help='Experimental Pikmin 2 source identities via the versioned admission bridge; requires a lane 04 placement document')
