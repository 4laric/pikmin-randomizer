...
def main():
    ...
    gen.add_argument('--p2-enemies', action='store_true', help='Experimental Pikmin 2 source identities via the versioned admission bridge; needs lane 04 targets or a placement document')
    gen.add_argument('--p2-targets', default=None, help='Comma-separated binding targets for --p2-enemies')
    gen.add_argument('--p2-placement', type=Path, help='Lane 04 placement/encounter JSON document supplying legal binding targets')
