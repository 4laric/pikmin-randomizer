...
def main():
    ...
    gen.add_argument('--p2-species', help="With --p2-enemies: 'playable' (only species the launcher can run today) or comma-separated admitted source ids; default all admitted")
