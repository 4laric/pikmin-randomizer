...
#ifdef PIKI_PC_PORT
    if (!pc_p2_sheargrub_draw(this, gfx, mat, true) && !pc_p2_snow_draw(this, gfx, mat, true))
#endif
...
#ifdef PIKI_PC_PORT
        if (!pc_p2_sheargrub_draw(this, gfx, onCamMtx) && !pc_p2_snow_draw(this, gfx, onCamMtx))
#endif
