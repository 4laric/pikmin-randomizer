...
`tests/test_pikmin2_kogane_cave.py`, and an additive native re-entry dedupe in
...
| Cave relocation model | PASS (host) | `resolve_flip(..., 0, in_cave=True)['relocate']`; `tests/test_pikmin2_kogane_cave.py` |
