...
Open **F1 > Mods > Disable Tutorials**, set **On**, then return and select **Save**. Off is the default for new installations and old config files, preserving original gameplay. The option uses the normal pending/apply/cancel settings behavior.
