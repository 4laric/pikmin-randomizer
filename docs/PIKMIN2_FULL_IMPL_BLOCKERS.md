...
| Flora & Candypops (#171) | Native display + lifecycle (all six gates for the Pelplant proxy) | Pelplant poses convert (10/10); a non-invincible Pelplant proxy passes spawn/draw/injected-death/cleanup/generator-respawn/tolerant-rebind-re-entry and transport/Pod reward (`P2_POD_RECEIPT corpse:353001 value=2 new=1 seeds=0`, repairs unchanged) via a converted Pod room (#397, [doc](PIKMIN2_FLORA_LIFECYCLE_RUNTIME.md)). Still open: source Pelplant FSM + pellet capture/release and Onion seed reward (the proxy delivers a P1 Chappy corpse for Pokos), Candypop conversion/refund, plant/seed lifecycle, HikariKinoko shape-matrix type 1; native `opencode/p2-lifecycle-native` @ `fb6389ce` pending export/#186 review | #171, #353, #397, #405 |
