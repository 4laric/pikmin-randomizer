...
| Flying (#166) | Native display; Mar source FSM done (#407) | Source Hanachirashi/ShijimiChou FSM; full P2 wind cone/effect + flick/shake-off; corpse/reward; ShijimiChou runtime ownership (colour/nectar, owned by its family); blowhog btk/brk preservation; cleanup | #166, #348, #375, #407 |
| Aquatic (#167) | Native display; Tadpole source FSM done (#407) | Source FSM: Catfish (KochappyBase host + shadow), Jigumo (owns `PanHouse`/nest), UmiMushi boss; true `MoveWater`/water receivers; eat/flick; corpse/carry; cleanup | #167, #347, #374, #407 |
