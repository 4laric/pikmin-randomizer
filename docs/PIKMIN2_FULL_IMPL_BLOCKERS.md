...
|---|---|---|---|
| Ground invertebrates (#165) | Native display; Sokkuri + Armor + ElecBug source FSMs done (#407) | Source FSM for Imomushi, TamagoMushi and Hana (Imomushi plant eat/climb; Hana `ChappyBase` FSM + wake; TamagoMushi manager limits); remaining animation-event execution (damage/drop/flick); ElecBug two-beetle partner link; Imomushi climb/attack; corpse/carry/reward; Piklopedia; cleanup/re-entry; Armor `dmg1` receiver rule and bridge states | #165, #346, #388, #407 |
