...
| Flying (#166) | Native display; Mar + Hanachirashi source FSMs done (#407) | Source ShijimiChou runtime ownership (colour/nectar); full P2 wind cone/effect + flick/shake-off; corpse/reward; blowhog btk/brk preservation; cleanup | #166, #348, #375, #407 |
| Aquatic (#167) | Native display; Tadpole + Catfish source FSMs done (#407) | Source FSM: Jigumo (owns `PanHouse`/nest), UmiMushi boss; true `MoveWater`/water receivers; eat/flick; corpse/carry; cleanup | #167, #347, #374, #407 |
...
| Snagret (#174) | Native display; DangoMushi source FSM done (#407) | Source `SnakeJointMgr` FSM (burrow/emerge, 5-way bite, `run1` jump) for SnakeCrow/SnakeWhole; falling Rock/Egg spawner; White Flower Garden `mWFGHealth` override; DangoMushi Turn invulnerability + child spawner; corpse/carry; cleanup | #174, #351, #376, #407 |
