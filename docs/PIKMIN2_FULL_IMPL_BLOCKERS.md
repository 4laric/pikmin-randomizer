...
| Flora & Candypops (#171) | Native display + lifecycle (Pelplant proxy) | Pelplant poses convert (10/10) and a non-invincible Pelplant proxy passes spawn/draw/injected-death/cleanup/generator-respawn/re-entry (#397, [doc](PIKMIN2_FLORA_LIFECYCLE_RUNTIME.md)); still open: source Pelplant FSM + pellet capture/release receptor + Pikmin transport/Pod reward, re-entry visual re-bind (strict `pc_p2_batch2_setup` all-actors re-scan), Candypop conversion/refund, plant/seed lifecycle, HikariKinoko shape-matrix type 1 | #171, #353, #397, #405 |
