...
| Flora & Candypops (#171) | Native display | Pelplant poses now convert (10/10) via the #405 singular-scale policy; HikariKinoko (0/1) still stuck on shape-matrix type 1 (billboard) — #128 converter; Candypop conversion/refund predicate + Pelplant-Pom receptor; plant/seed lifecycle; cleanup/reload | #171, #353, #397, #405 |
