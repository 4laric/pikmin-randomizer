...
| 4. Death and corpse | PASS | output/dsw/l27-out/teki-arena19/60868e6c81ae4698b997cff7bbb1fd09/run.log:1303 P2_BOMBSARAI_TEKI_DEAD, :1306 P2_BOMBSARAI_TEKI_CORPSE_CONFIG carry_min=3 carry_max=6 min_free_slot=0 alive=1 (natural kill by FreeMode Pikmin attacks + natural engine carcass Pellet via becomePellet/LeaveCorpse; the identity caveat is recorded in gate 1) | natural |
