...
Current draft integration: [sweep #456](PIKMIN2_INTEGRATION_456.md). The batch evidence below describes the worker build; #449 records combined build results and remaining gaps.
