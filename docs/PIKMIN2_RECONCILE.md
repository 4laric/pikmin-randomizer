...
Current draft integration: [sweep #450](PIKMIN2_INTEGRATION_450.md). The batch evidence below describes the worker build; #449 records combined build results and remaining gaps.
