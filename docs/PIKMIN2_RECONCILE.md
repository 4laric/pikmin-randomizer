...
Current draft integration: [sweep #451](PIKMIN2_INTEGRATION_451.md). The batch evidence below describes the worker build; #449 records combined build results and remaining gaps.
