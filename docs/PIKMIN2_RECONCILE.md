...
Current draft integration: [sweep #455](PIKMIN2_INTEGRATION_455.md). The batch evidence below describes the worker build; #449 records combined build results and remaining gaps.
