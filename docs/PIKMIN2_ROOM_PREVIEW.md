...
Player follow-up (2026-09-12): after the floor and carry-route corrections, the user confirmed the preview works. This is manual confirmation of the reported movement/carrying problem being resolved, not full campaign validation. Next scope: [Pikmin 2 implementation plan](PIKMIN2_IMPLEMENTATION_PLAN.md).
