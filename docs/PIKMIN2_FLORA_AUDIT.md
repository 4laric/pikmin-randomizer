...
> Copied verbatim from the original audit on branch
> `claude/p2-treasure-equipment` (also under
> `output/tracks/p2-catalog/docs/PIKMIN2_FLORA_AUDIT.md`). Credit to the
> original audit author; this copy exists so lane 23's behavior model can cite
> it directly. It is unchanged apart from this note.
