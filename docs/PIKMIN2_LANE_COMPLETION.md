...
Use [native handoff integration continuation](PIKMIN2_NATIVE_HANDOFF_INTEGRATION_437.md) for accepted commits, tests and concrete limitations. “Acceptance” means the delivered slice is integrated and still needs the listed real gameplay evidence. It does not admit an identity into the randomizer.
