...
- Fixture2 (current): `output/muse-wave/l62/fixture2/` built against native
  ...
  (provenance `built`, `fixture2/baseline/provenance.json`).
...
`experimental.pikmin2_muse_longlegs.run(assets, imported, run3, fixture2/fixture.exe)` /
`output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3` (fresh arena,
...
`output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log:7`
...
L62RUN = `output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log`.
...
|---|---|---|---|
| 1. Exact identity and spawn | PASS (natural) | output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log:730 (BIND generator=312001 species=Houdai native_fsm=implemented) | natural |
| 2. Autonomous movement and animation | PASS (natural) | output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log:850 (WALK from=150.7,1844.5 to=166.5,1813.9 speed=250.0) :864 (WALK_END distance=59.7 seconds=1.27, avg 47 u/s inside source 250 u/s budget); legs bind-pose, no IK articulation (approximation documented above); arena actor residual P1 locomotion disclosed above | natural |
| 3. Attacks and receivers | PASS (natural) | output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log:913 (SHELL) :914 (SHELL_HIT pikmin=1, source InteractBomb receiver; six more shell/hit pairs :915-:941) | natural |
| 4. Death and corpse | PASS (natural) | output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log:944 (DEAD prior_health=10.00, drained 130 to 0, no lethal write) :1443 (NATURAL_DEATH houdai=1); no Houdai BIRTH line (source deathChildren 0); fallen pellet is the arena actor P1 pellet, not a source carcass (see gate 5) | natural |
...
| Gate | Result | Evidence | Injected vs natural |
|---|---|---|---|
| 1. Exact identity and spawn | PASS (natural) | output/muse-wave/l62/run3/84a93fdf00b5400ca46310974e4d8cb3/capture/native.log:731 (BIND generator=312002 species=BigFoot native_fsm=implemented) | natural |
...
- The P1 Chappy placement vehicle retains its own residual locomotion; the
  reported 59.7 u Walk displacement is the owned host's applied source-rule
...
(Native `b024c88c` already built in `output/msw/native-l62-build`; fixture2
provenance `built`.)
